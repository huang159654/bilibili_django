...
SECRET_KEY = 'django-insecure-2#3)b5eq0(obgx10ztoba)958+nmzjv^(-k=79*is^chz8v83('
...
AUTH_USER_MODEL = 'data.UserModel'
...
SIMPLE_JWT = {
    ...
    'TOKEN_OBTAIN_SERIALIZER': 'data.serializers.TokenObtainPairSerializer'
}
